        ...
        <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
          <div className="flex flex-col items-center md:items-start">
            <img
              ...
              alt="Company Logo"
            />
            <p className="my-4">Email us: AAStores@example.com</p>
            <p>UAN: 000 111-11-1111</p>
          ...
          <div className="pr-5 flex flex-col items-center md:items-start mt-8 md:mt-0">
            ...
            <div className="flex space-x-4 mt-4">
              ...
              <img
                className="h-7 w-7"
                src="https://cdn1.iconfinder.com/data/icons/ecommerce-495/32/cash_on_delivery_delivery_ecommerce_shop_market-512.png"
                alt=""
              />
            </div>
          </div>
